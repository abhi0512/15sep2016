...
- (void)layoutSubviews {
    ...
    if (self.sent == YES) {
        ...
        avatarImageFrame = CGRectMake(5.0f, timeLabelFrame.size.height, 30.0f, 30.0f);
        ...
        avatarImageFrame = CGRectMake(self.frame.size.width - 55.0f, timeLabelFrame.size.height, 30.0f, 30.0f);
    }
    ...
    [self.messageLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:12]];
    ...
    if (self.timeLabel.text != nil) {
        ...
        [self.timeLabel setFont:[UIFont fontWithName:@"Roboto-Light" size:10]];
